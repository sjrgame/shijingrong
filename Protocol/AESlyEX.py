...
# 注意加密字符不超过16个字节
# 自己实现了一个aes类，用于aes的加密和解密加密字符不超过16个字节
class ly_aes():
    # key为aes秘钥,mode为加密模式
...
def  main():
    ...
    # 秘钥的长度必须为16
    crypt = ly_aes(key)
    # 这里选用的是ECB模式 01,7fe3724d3cdcd8eedf11951f187641e2, 00,0f2c2a0c30fbddb5e5d8499a7e177726
    msg = '00'
    ms = 'fb4663cecea43421d620347ff2ac393a'
    # ms = '+0Zjzs6kNCHWIDR/8qw5Og=='
    msg1 = 'abcdefhijmnlksi'
    ...
    # 加密字符串
    cipher = crypt.encrypt(msg1, len(msg1))
    # 返回值是内存中的16进制字符串
    print(cipher)
